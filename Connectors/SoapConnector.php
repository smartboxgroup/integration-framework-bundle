 ...
 */
class SoapConnector extends APIConnector
{
    ...
    protected function translateFromCanonical(SerializableInterface $entity = null, array $options = array())
    {
        if ($entity instanceof SerializableArray) {
            ...
            throw new \Exception(
                "The default SoapConnector can only process a SerializableArray. To override this please override the translateFromCanonical method."
            );
        }
    }
