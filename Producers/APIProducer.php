 ...
 */
abstract class APIProducer extends Producer
{
    ...
    /**
     * Transform data from the canonical model to the model that this producer understands
     *
    ...
    /**
     * Transform data from the the model that this producer understands to the canonical model
     *
     * @param $data
     * @param array $options
     * @return mixed
