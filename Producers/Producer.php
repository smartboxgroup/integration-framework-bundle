...
abstract class Producer extends Service implements ProducerInterface
{
    ...
    /**
     * Get the producer default options
     * @return array
     */
    ...
    public function getAvailableOptions(){
        return array(
            self::OPTION_EXCHANGE_PATTERN => array('Exchange pattern to communicate with this producer', array(
            ...
            self::OPTION_RETRIES => array('Number of times that the messages should try to be redelivered to this producer', array()),
