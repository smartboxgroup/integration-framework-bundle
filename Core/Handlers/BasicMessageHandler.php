 ...
 */
class BasicMessageHandler extends Service implements HandlerInterface, ContainerAwareInterface
{
    ...
    public function handle(MessageInterface $message, EndpointInterface $endpointFrom)
    {
        ...
        $result = $this->processExchange($exchange);
     ...
     * @throws RecoverableExceptionInterface|ProcessingException
     */
    public function processExchange(Exchange $exchange, $retries = 0, $handleExceptions = true)
    {
